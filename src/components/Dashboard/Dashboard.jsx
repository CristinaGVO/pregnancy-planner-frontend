...
// ✅ Interpreta strings tipo "YYYY-MM-DD HH:MM:SS" como hora LOCAL (sin TZ)
    ...
    <main className="container">
      ...
      <div className="hero" style={{ padding: 14 }}>
        <div className="hero-row" style={{ alignItems: "center" }}>
          {/* ✅ Logo next to title */}
          <div className="brand brand--withLogo">
            <img className="brand-logo brand-logo--sm" src={logo} alt="Pregnancy Planner logo" />
            <div>
      ...
      <section className="grid-2 dashboard-grid" style={{ marginTop: 14 }}>
        ...
        <div className="card soft dashboard-card">
          <div className="dashboard-cardInner">
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="dashboard-actionsBottom">
              ...
              <>
                <div className="dashboard-row">
                  <span className="dashboard-number">{weeksLeft}</span>
                  <span className="muted dashboard-smallText">
                    weeks left to meet your baby
                  </span>
                </div>

                <div className="dashboard-info">
                  <div className="muted dashboard-smallText">
                    <span className="strong">Due:</span> {dueDateISO}
                  </div>
          ...
          <div className="dashboard-cardInner">
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="dashboard-info" style={{ marginTop: 10 }}>
                  <div className="muted dashboard-smallText">
                    <span className="strong">Date:</span>{" "}
                    {formatDateOnly(nextAppointment.date_time)}
                  </div>
                  <div className="muted dashboard-smallText">
                    <span className="strong">Time:</span>{" "}
                    {formatTimeOnly(nextAppointment.date_time)}
                  </div>
                </div>
